...
public class SignUp extends TestBase {
	...
	public void InvalidPhonenumberSignUp() throws IOException, InterruptedException {
		...
		SignUpPageObj.SelectSearchedCountryCode();
		SignUpPageObj.EnterPhoneNumber("0805" + RandomNigeriaPhoneGenerator());
		SignUpPageObj.ClickTermConditionButton();
...
//	@Test(priority = 3, description = "This test case will check user can't use Invalid otp to verify phonenumber")
	...
	public void InvalidPasswordCheck5() throws IOException, InterruptedException {
		...
		Reporter.log("Test to confirm user must provide password that contains 1 Special Character started !!!", true);
		SignUpPageObj.EnterPassword("ADEMOLA1@");
...
//	@Test(priority = 1, description = "This test case will verify user can signup with google account")
	public void SignUpGoogle() throws IOException, InterruptedException {

		Reporter.log("Test to verify user can signup with with google account started !!!", true);
		NavigateHomePage();
		SignUpPageObj.ClickSignUpButton();
		SignUpPageObj.clickSignupGoogle_Btn();
		// Switch Window
