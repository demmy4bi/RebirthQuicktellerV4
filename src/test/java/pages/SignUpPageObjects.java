...
public class SignUpPageObjects extends TestBase {
	...
	String GoogleSignupPagemessage = "Use your Google Account";
	...
	public void EnterPassword(String text) throws IOException, InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, 30);
		wait.until(ExpectedConditions.elementToBeClickable(chooseElement("password_NAME"))).click();
	...
	public void EnterconfirmPassword(String text) throws IOException, InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, 30);
		wait.until(ExpectedConditions.elementToBeClickable(chooseElement("ConfirmPassword_NAME"))).click();
	...
	public void Passwordpage() throws IOException {
		String actualmessage = new WebDriverWait(driver, 30)
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//label[contains(.,'Password')]")))
				.getText();
	...
	/*
	 * public void clickSignupGoogle_Btn() throws IOException { WebDriverWait wait =
	 * new WebDriverWait(driver, 30);
	 * wait.until(ExpectedConditions.elementToBeClickable(chooseElement(
	 * "clickSignupGoogle_XPATH"))).click();
	 * Reporter.log("Sign up with google button clicked", true); }
	 */
	
	public void clickSignupGoogle_Btn1() throws IOException {
		WebDriverWait wait = new WebDriverWait(driver, 30);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[contains(.,'Sign up with Google')]"))).click();
		Reporter.log("Sign up with google button clicked", true);
	}
	
	public void clickSignupGoogle_Btn() {
	    WebDriverWait wait = new WebDriverWait(driver, 30);
	    WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
	            "//div[contains(@class,'nsm7Bb-HzV7m-LgbsSe-bN97Pc-sM5MNb')]")));
